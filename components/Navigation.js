      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <button
              className={`relative px-5 py-2 text-sm font-medium transition-all duration-500 overflow-hidden ${
                scrolled
        ...
        >
          <div className="py-6 border-t border-slate-800/30">
            <div className="flex flex-col gap-4">
              ...
              <button className="mt-4 px-5 py-3 text-sm border border-cyan-400/50 text-cyan-400 hover:bg-cyan-400/10 transition-all duration-300">
                Request Access
              </button>
            </div>
          </div>
